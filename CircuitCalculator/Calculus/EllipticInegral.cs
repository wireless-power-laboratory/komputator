...
namespace CircuitCalculator.Calculus
{
    ...
    /// <summary>
    /// Class for elliptical integral calculations.
    /// </summary>
    public class Elliptic
    {
        ...
        /// </summary>
        /// <param name="m">The value to be computed.</param>
        public static double EllipticIntegralK(double m)
        {
            var result = EllipticIntegralKHighPrecision(1.0 - m);
            return result;
        }
        /// <summary>
        /// Complete elliptic integral of the first kind
        ...
        ///    IEEE       0,1        30000       2.5e-16     6.8e-17
        /// </summary>
        /// <param name="m1">The value to be computed.</param>
        public static double EllipticIntegralKHighPrecision(double m1)
        {
            double result;

            if (m1 <= Functions.MachineEpsilon)
            {
        ...
        *************************************************************************/
        /// <summary>
        /// Incompletes the elliptic integral K.
        /// </summary>
        /// <param name="phi">The function phi.</param>
        /// <param name="m">The value to be computed.</param>
        public static double IncompleteEllipticIntegralK(double phi, double m)
        {
            ...
            d = 1;
            md = 0;
            while ((double)(Math.Abs(c / a)) > (double)(Functions.MachineEpsilon))
            {
                temp = b / a;
    ...
    /// <summary>
    /// A wrapper class for <see cref="Elliptic"/> class.
    /// </summary>
    public class EllipticInegral
    {
        /*************************************************************************
   Complete elliptic integral of the first kind
   ...
   *************************************************************************/
        public static double EllipticIntegralK(double m)
        {
            var result = Elliptic.EllipticIntegralK(m);
            return result;
        }
        /*************************************************************************
        Complete elliptic integral of the first kind
        ...
        *************************************************************************/
        public static double IncompleteEllipticIntegralK(double phi, double m)
        {
            var result = Elliptic.IncompleteEllipticIntegralK(phi, m);
            return result;
        }
        /*************************************************************************
        Complete elliptic integral of the second kind
