...
namespace CircuitCalculator.Plot3D
{
    ...
    public static class FunctionCompiler
    {
        ...
        public static CompiledFunction Compile(int parametersCount, string functionBody)
        {
            ...
            {
                throw new FunctionNotCompiledException(Properties.Resources.FunctionCompiler_SemicolonException);
            }
            ...
            string str = string.Format(Properties.Resources.FunctionCompiler_EvalClass, strb.ToString(), typeof(CompiledFunction).Namespace);
