...
namespace Integrator
{
    ...
    public class SimpsonIntegrator
    {
        ...
        static public double Integrate(Function f, double a, double b, double desiredRelativeError)
        {
        ...
        /// <returns>Integral value</returns>
        static public double Integrate(Function f, double a, double b, double relativeErrorTolerance, int log2MaxFunctionEvals, out int functionEvalsUsed, out double estimatedError)
        {
            double integral = 0.0;
